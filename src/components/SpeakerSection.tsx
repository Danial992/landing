...
const SpeakerSection: React.FC = () => {
  ...
  return (
    <section className="py-20 px-6 bg-[#143A41] text-white">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl lg:text-5xl font-bold mb-6">
            Почему стоит учиться именно у <span className="text-[#53A4B1]">Мадияра Кыстаубаева</span>
          </h2>
        </div>

        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            <div className="bg-[#53A4B1] text-[#143A41] rounded-2xl p-8 shadow-lg">
              <h3 className="text-3xl font-bold mb-6 text-center">Мадияр Кыстаубаев</h3>
              <div className="space-y-4 text-lg">
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-[#143A41] rounded-full"></div>
            ...
            <div className="text-center">
              ...
              <p className="text-[#53A4B1] font-semibold">— Мадияр Кыстаубаев</p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {achievements.map((achievement, index) => (
              <div
                key={index}
                className="bg-[#306770] rounded-xl p-6 border border-[#143A41] shadow hover:bg-[#38747E] transition-colors"
              >
                <div className="flex items-start space-x-4">
                  <div className="bg-[#53A4B1] p-3 rounded-lg text-[#143A41]">
                    {achievement.icon}
                  </div>
                  <div>
                    <h4 className="font-bold text-lg text-[#53A4B1] mb-1">
                      {achievement.title}
                    </h4>
